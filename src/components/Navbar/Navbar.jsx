...
const Navbar = () => {
  return (
    <>
      <div className="w-ful h-18 bg-[#3A3A87] flex justify-between items-center text-amber-50 p-2 px-6">
        {/* left  */}
        <div className="w-[40%] flex justify-between">
          ...
          <div className="flex gap-3 items-center">
            <div className="bg-[#F24566] p-2 rounded text-white hover:bg-[#cd536a]">
      ...
      {/* sidebar */}
      <div className="fixed left-0 hidden md:block w-18 p-4 text-white bg-blue-950 top-18">
        <div>
          <div>
            <h3>Dashboard</h3>
          </div>
